...
fn helvetica_widths(_variant: &[u8]) -> Vec<f64> {
    ...
    // Uppercase A-Z
    let upper = [
        667.0, 667.0, 722.0, 722.0, 667.0, 611.0, 778.0, 722.0, 278.0, 500.0, 667.0, 556.0, 833.0,
        722.0, 778.0, 667.0, 778.0, 722.0, 667.0, 611.0, 722.0, 667.0, 944.0, 667.0, 667.0, 611.0,
    ];
...
fn times_widths(_variant: &[u8]) -> Vec<f64> {
    ...
    let upper = [
        722.0, 667.0, 667.0, 722.0, 611.0, 556.0, 722.0, 722.0, 333.0, 389.0, 722.0, 611.0, 889.0,
        722.0, 722.0, 556.0, 722.0, 667.0, 556.0, 611.0, 722.0, 722.0, 944.0, 722.0, 722.0, 611.0,
    ];
    for (i, &width) in upper.iter().enumerate() {
        w[65 + i] = width;
    }
